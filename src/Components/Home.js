          ...
          <Row>
            ...
            >
              ...
              >
                ...
                <CardBody>
                  2pa 3p 3pa assist percentage (available since the 1964-65
                  season in the nba); the formula is 100 * ast / (((mp / (tm mp
                  / 5)) * tm fg) - fg). assist percentage is an estimate of the
                  percentage of teammate field goals a player assisted while he
                  was on on the floor. blk% fg% field goal attempts (includes
                  both 2-point field goal attempts and 3-point field goal
                  attempts) ft g gmsc pace per 36 minutes a statistic (e.g.,
                  assists) divided by games. pprod stl steal percentage
                  (available since the 1973-74 season in the nba); the formula
                  is 100 * (stl * (tm mp / 5)) / (mp * opp poss). steal
                  percentage is an estimate of the percentage of opponent
                  possessions that end with a steal by the player while he was
                  on
                </CardBody>
                <img src="http://bit.ly/2jxzVXo" style={{ padding: "30px" }} />
                <CardBody>
                  the floor. stops; dean oliver's measure of individual
                  defensive stops. please see dean's book for details. tov tsa
                  true shooting attempts; the formula is fga + 0.44 * fta. usage
                  percentage (available since the 1977-78 season in the nba);
                  the formula is 100 * ((fga + 0.44 * fta + tov) * (tm mp / 5))
                  / (mp * (tm fga + 0.44 * tm fta + tm tov)). usage percentage
